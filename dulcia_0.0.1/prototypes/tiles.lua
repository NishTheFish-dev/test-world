...
data:extend({
  {
    ...
    transitions = util.table.deepcopy(base_deepwater.transitions or {}),
    transitions_between_transitions = util.table.deepcopy(base_deepwater.transitions_between_transitions or {}),
  ...
  },
  {
    ...
    transitions = util.table.deepcopy(base_water.transitions),
    transitions_between_transitions = util.table.deepcopy(base_water.transitions_between_transitions or {}),
  ...
  },
  {
    ...
    transitions = util.table.deepcopy(base_shallow.transitions or {}),
    transitions_between_transitions = util.table.deepcopy(base_shallow.transitions_between_transitions or {}),
